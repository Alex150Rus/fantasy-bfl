...
router.get('/', async (req, res) => {
  try {
    ...
    const result = await client.query("SELECT results.id, date, weekday, time, year, team, homeTeamGoals, guestTeamGoals FROM results INNER JOIN teams ON (teams.id = results.guestTeamId or teams.id = results.homeTeamId);");
